...
<report name="REPORT6" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="REPORT6" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="FOOD">
      <select>
      <![CDATA[select ID ID, NAME NAME, PRICE PRICE, TYPE TYPE from FOOD]]>
      </select>
      ...
      <group name="G_ID">
        ...
        <dataItem name="ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Id">
          <dataDescriptor expression="ID" descriptiveExpression="ID" order="1"
           width="22" scale="-127"/>
        ...
        <dataItem name="PRICE" oracleDatatype="number" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="Price">
          <dataDescriptor expression="PRICE" descriptiveExpression="PRICE"
        ...
        <dataItem name="TYPE" datatype="vchar2" columnOrder="14" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Type">
          <dataDescriptor expression="TYPE" descriptiveExpression="TYPE"
           order="4" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
      ...
      <frame name="M_G_ID_GRPFR">
         ...
         minWidowRecords="1" columnMode="no">
          ...
          <field name="F_ID" source="ID" minWidowLines="1" spacing="0"
           alignment="start">
            ...
            <geometryInfo x="0.00000" y="0.18750" width="0.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_NAME" source="NAME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.43750" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_PRICE" source="PRICE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.87500" y="0.18750" width="0.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_TYPE" source="TYPE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.25000" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_ID_HDR">
          ...
          <text name="B_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.43750" y="0.00000" width="1.43750"
             height="0.18750"/>
          ...
          <text name="B_PRICE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.87500" y="0.00000" width="0.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_TYPE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.25000" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGIDGRPFR124">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBID124" asArray="no"/> class="OraColumnHeader"> Id </th>
   <th <rw:id id="HBNAME124" asArray="no"/> class="OraColumnHeader"> Name </th>
   <th <rw:id id="HBPRICE124" asArray="no"/> class="OraColumnHeader"> Price </th>
   <th <rw:id id="HBTYPE124" asArray="no"/> class="OraColumnHeader"> Type </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGID1241" src="G_ID">
   <tr>
    <td <rw:headers id="HFID124" src="HBID124"/> class="OraCellNumber"><rw:field id="FID124" src="ID" nullValue="&nbsp;"> F_ID </rw:field></td>
    <td <rw:headers id="HFNAME124" src="HBNAME124"/> class="OraCellText"><rw:field id="FNAME124" src="NAME" nullValue="&nbsp;"> F_NAME </rw:field></td>
    <td <rw:headers id="HFPRICE124" src="HBPRICE124"/> class="OraCellNumber"><rw:field id="FPRICE124" src="PRICE" nullValue="&nbsp;"> F_PRICE </rw:field></td>
    <td <rw:headers id="HFTYPE124" src="HBTYPE124"/> class="OraCellText"><rw:field id="FTYPE124" src="TYPE" nullValue="&nbsp;"> F_TYPE </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
