...
<report name="foodReport" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL FOOD.ID, FOOD.NAME, FOOD.PRICE, FOOD.TYPE
FROM FOOD ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_ID">
        <displayInfo x="1.45007" y="1.94995" width="1.09998" height="0.97949"
        />
        <dataItem name="ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Id">
          <dataDescriptor expression="FOOD.ID" descriptiveExpression="ID"
           order="1" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NAME" datatype="vchar2" columnOrder="12" width="50"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Name">
          <dataDescriptor expression="FOOD.NAME" descriptiveExpression="NAME"
           order="2" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PRICE" oracleDatatype="number" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="Price">
          <dataDescriptor expression="FOOD.PRICE"
           descriptiveExpression="PRICE" order="3" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TYPE" datatype="vchar2" columnOrder="14" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Type">
          <dataDescriptor expression="FOOD.TYPE" descriptiveExpression="TYPE"
           order="4" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountIDPerReport" source="ID" function="count"
  ...
  <section name="main">
    <body>
      <frame name="M_G_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.81250" height="0.56250"
        />
        ...
        <repeatingFrame name="R_G_ID" source="G_ID" printDirection="down"
         minWidowRecords="1" columnMode="no">
          ...
          <field name="F_PRICE" source="PRICE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="3.00000" y="0.18750" width="0.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_TYPE" source="TYPE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="3.37500" y="0.18750" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_ID_FTR">
          ...
          <field name="F_CountIDPerReport" source="CountIDPerReport"
        ...
        <frame name="M_G_ID_HDR">
          ...
          <text name="B_PRICE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.00000" y="0.00000" width="0.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_TYPE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.37500" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGIDGRPFR166">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBID166" asArray="no"/> class="OraColumnHeader"> Id </th>
   <th <rw:id id="HBNAME166" asArray="no"/> class="OraColumnHeader"> Name </th>
   <th <rw:id id="HBPRICE166" asArray="no"/> class="OraColumnHeader"> Price </th>
   <th <rw:id id="HBTYPE166" asArray="no"/> class="OraColumnHeader"> Type </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGID1661" src="G_ID">
   <tr>
    <td <rw:headers id="HFID166" src="HBID166"/> class="OraCellNumber"><rw:field id="FID166" src="ID" nullValue="&nbsp;"> F_ID </rw:field></td>
    <td <rw:headers id="HFNAME166" src="HBNAME166"/> class="OraCellText"><rw:field id="FNAME166" src="NAME" nullValue="&nbsp;"> F_NAME </rw:field></td>
    <td <rw:headers id="HFPRICE166" src="HBPRICE166"/> class="OraCellNumber"><rw:field id="FPRICE166" src="PRICE" nullValue="&nbsp;"> F_PRICE </rw:field></td>
    <td <rw:headers id="HFTYPE166" src="HBTYPE166"/> class="OraCellText"><rw:field id="FTYPE166" src="TYPE" nullValue="&nbsp;"> F_TYPE </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 <!-- Report Level Summary -->
 <tr>
  <td <rw:headers id="HFCountIDPerReport166" src="HBID166"/> class="OraTotalNumber">Count: <rw:field id="FCountIDPerReport166" src="CountIDPerReport" nullValue="&nbsp;"> F_CountIDPerReport </rw:field></td>
